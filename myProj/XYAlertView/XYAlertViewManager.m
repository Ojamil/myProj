...
-(UIImage*)buttonImageByStyle:(XYButtonStyle)style state:(UIControlState)state
{
    switch(style)
    {
        ...
        case XYButtonStyleGreen:
            return [[UIImage imageNamed:(state == UIControlStateNormal ? @"button.png" : @"button-pressed.png")] stretchableImageWithLeftCapWidth:22 topCapHeight:22];
    }
}
...
-(void)prepareAlertToDisplay:(XYAlertView*)entity
{
    ...
    _alertView = nil;
    _alertView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"alert-bg.png"] stretchableImageWithLeftCapWidth:34 topCapHeight:44]];
